# Output information needed to log into RAM
output "ram_login_name" {
  description = "RAM account login name"
  value       = alicloud_ram_login_profile.ram-billing-profile.user_name
}

output "ram_login_password" {
  description = "RAM account password"
  value       = alicloud_ram_login_profile.ram-billing-profile.password
}
